...
const Login = () => {
  return (
    <div className=" h-screen w-screen flex flex-col items-center justify-center grid grid-cols-2 ">
      <img
        className=" max-md:hidden h-screen w-screen flex items-center justify-center bg-img object-cover opacity-80"
        src={foto}
        alt=""
      />
      <div
        id="form"
        className="bg-neutral-800 col-start-2  min-h-full flex-1 flex-col justify-center px-6 py-12 lg:px-8 max-md:col-span-2"
      >
        ...
        <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
          <form className="space-y-6" action="#" method="POST">
            <div>
              <label
                htmlFor="email"
                className="text-yellow-500 block text-sm font-medium leading-6 text-gray-900"
              >
                Email
              </label>
              <div className="mt-2">
            ...
            <div>
              <div className="flex items-center justify-between">
                ...
                <div className="text-sm">
                  <a
                    href="#"
                    className="text-yellow-500 font-semibold text-indigo-600 hover:text-indigo-500"
                  >
                    Esqueceu sua senha?
                  </a>
                </div>
          ...
          <p className="mt-10 text-center text-sm text-white">
            ...
            <Link
              to={"/register"}
              className="font-semibold leading-6 text-yellow-500 hover:text-indigo-500"
            >
              Registre-se
            </Link>
          </p>
